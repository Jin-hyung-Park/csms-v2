                  ...
                  <div className="mb-3 flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-1 text-sm font-semibold text-slate-700 transition hover:bg-slate-100"
                      >
                        수정
                      </button>
                      <button
                        ...
                        className="rounded-xl border border-red-200 bg-red-50 px-3 py-1 text-sm font-semibold text-red-700 transition hover:bg-red-100 disabled:opacity-50"
                      >
                        삭제
                      </button>
                    </div>
